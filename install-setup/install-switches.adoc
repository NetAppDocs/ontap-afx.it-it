...
NOTE: Se il flusso d'aria degli switch è configurato per l'aspirazione lato porta (ventole e alimentatori di colore bordeaux), le porte di rete degli switch devono essere installate rivolte verso la parte anteriore del cabinet e le ventole di scarico devono essere rivolte verso la parte posteriore del cabinet. Con questa configurazione, è necessario assicurarsi di utilizzare cavi sufficientemente lunghi da collegare le porte di rete nella parte anteriore del cabinet alle porte di storage nella parte posteriore del cabinet. + Per informazioni più dettagliate su questi switch, visitare il sito web Cisco: https://www.cisco.com/c/en/us/td/docs/dcn/hw/nx-os/nexus9000/9332d-gx2b/cisco-nexus-9332d-gx2b-nx-os-mode-switch-hardware-installation-guide.html["Guida all'installazione hardware dello switch Cisco Nexus 9332D-GX2B NX-OS Mode"^] e  https://www.cisco.com/c/en/us/td/docs/dcn/hw/nx-os/nexus9000/9364d-gx2a/cisco-nexus-9364d-gx2a-nx-os-mode-switch-hardware-installation-guide.html["Guida all'installazione hardware dello switch Cisco Nexus 9364D-GX2A NX-OS Mode"^].
