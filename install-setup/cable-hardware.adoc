...
+
image::../media/drw_afx_ha_cluster_storage_a_ieops-2779.svg[Cluster del controller via cavo,800px,and storage to switch A]
...
+
image::../media/drw_afx_ha_cluster_storage_b_ieops-2780.svg[Cluster del controller via cavo,800px,and storage to switch B]
