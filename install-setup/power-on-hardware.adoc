...
* Per le distribuzioni AFX 1K con AI Data Engine (AIDE), vai a link:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["Installare i nodi di elaborazione dati AIDE"].
