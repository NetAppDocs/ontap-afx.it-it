...
.Cosa succederà ora?
Dopo aver acceso il tuo sistema storage AFX 1K, completa la configurazione in base all'opzione di distribuzione:

* Per le distribuzioni dedicate del sistema storage AFX 1K, vai su link:../install-setup/cluster-setup.html["Impostare un cluster AFX"].
* Per le implementazioni di AFX 1K con AI Data Engine (AIDE), installare i server di terze parti AIDE o i nodi di elaborazione dati forniti da NetApp:
