...
NOTE: Se si distribuisce AFX 1K con l'AI Data Engine (AIDE), installare i nodi di elaborazione dati AIDE dopo aver acceso il sistema AFX. Consultare link:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["Installare i nodi di elaborazione dati AIDE"] per ulteriori informazioni.
