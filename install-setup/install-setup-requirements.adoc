...
Un AFX 1K storage controller può pesare fino a 62,83 lb (28,5 kg). Per sollevare lo storage controller, usa due persone o un sollevatore idraulico.

.Precauzione per il sollevamento del controller AFX 1K.
image::../media/drw_a1k_weight_caution_ieops-1698.svg[Icona di avvertimento per il sollevamento di AFX 1K]
