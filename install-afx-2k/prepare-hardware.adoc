...
summary: 'Preparati a installare il sistema storage AFX 2K nel tuo ambiente ONTAP e a registrare l"hardware per accedere ai vantaggi dell"assistenza.' 
---
= Preparati a installare il tuo sistema storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Preparati a installare il tuo sistema storage AFX 2K preparando il sito, disimballando le scatole e confrontando il contenuto delle scatole con la bolla di accompagnamento, e registrando il sistema per accedere ai vantaggi dell'assistenza.
...
Per installare il tuo sistema storage AFX 2K, assicurati che il luogo di installazione e l'armadio o il rack che intendi utilizzare soddisfino le specifiche per la tua configurazione.
...
** 1U per lo switch Cisco Nexus 9332D-GX2B.
** 2U per lo switch Cisco Nexus 9364D-GX2A.
** 16U per lo switch Cisco Nexus 9808.
...
** Cisco Nexus 9808, 9332D-GX2B o 9364D-GX2A switch
...
Dopo che ti sei assicurato che il tuo sito soddisfi i requisiti delle specifiche del sistema storage AFX 2K e hai verificato di avere tutte le parti che hai ordinato, registra il tuo sistema storage.
...
Nuovo cliente NetApp
 a| 
.. Seleziona *Registrati ora* e crea un account.
...
.Cosa succederà ora?
Dopo che ti sei preparato per installare l'hardware AFX 2K, link:install-switches.html["Installa gli switch per il tuo sistema storage AFX 2K"].
