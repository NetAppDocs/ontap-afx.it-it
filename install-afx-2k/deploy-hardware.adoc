...
summary: 'Scopri come installare i kit di guide per il sistema storage AFX 2K e i ripiani storage, e come fissare l"hardware AFX nell"armadio o nel rack per telecomunicazioni.' 
---
= Installa il tuo sistema storage AFX 2K
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Dopo che hai installato gli switch, dovresti installare l'hardware per il tuo sistema storage AFX 2K. Per prima cosa, installa i kit di guide. Poi installa e fissa il tuo sistema storage in un armadio o in un rack telco.
...
. Se il tuo sistema storage AFX 2K è dotato di un dispositivo per la gestione dei cavi, fissalo sul retro del sistema storage.
+
...
.Cosa succederà ora?
Dopo aver installato l'hardware per il sistema AFX, rivedi il link:afx-cable-overview.html["Configurazioni di cablaggio supportate per il tuo sistema storage AFX 2K"].
