...
Nodi controller per cluster:: Ogni cluster AFX deve avere almeno quattro nodi. Il numero massimo di nodi varia in base alla release di ONTAP; ad esempio, la release 9.19.1 consente fino a 32 nodi per cluster AFX.
